...
local Themes = {
	...
	CyrusHubX = {
		Name = "CyrusHubX",
		Accent = Color3.fromRGB(70, 130, 255), -- Biru muda terang

		AcrylicMain = Color3.fromRGB(10, 25, 50), -- Biru tua gelap
		AcrylicBorder = Color3.fromRGB(30, 60, 110), -- Biru tua medium
		AcrylicGradient = ColorSequence.new(
			Color3.fromRGB(15, 35, 70), 
			Color3.fromRGB(5, 15, 30)
		), -- Gradient biru tua
		AcrylicNoise = 0.7,
	
		TitleBarLine = Color3.fromRGB(100, 150, 255), -- Biru muda
		Tab = Color3.fromRGB(70, 130, 255), -- Biru muda terang
	
		Element = Color3.fromRGB(70, 130, 255), -- Biru muda terang
		ElementBorder = Color3.fromRGB(40, 80, 140), -- Biru tua medium
		InElementBorder = Color3.fromRGB(100, 150, 255), -- Biru muda
		ElementTransparency = 0.75,
	
		ToggleSlider = Color3.fromRGB(100, 150, 255), -- Biru muda
		ToggleToggled = Color3.fromRGB(255, 255, 255), -- Putih
	
		SliderRail = Color3.fromRGB(100, 150, 255), -- Biru muda
	
		DropdownFrame = Color3.fromRGB(15, 35, 70), -- Biru tua
		DropdownHolder = Color3.fromRGB(25, 50, 100), -- Biru tua medium
		DropdownBorder = Color3.fromRGB(70, 130, 255), -- Biru muda terang
		DropdownOption = Color3.fromRGB(90, 160, 255), -- Biru muda lebih terang
	
		Keybind = Color3.fromRGB(60, 110, 220), -- Biru medium
	
		Input = Color3.fromRGB(200, 220, 255), -- Biru sangat muda/putih kebiruan
		InputFocused = Color3.fromRGB(255, 255, 255), -- Putih
		InputIndicator = Color3.fromRGB(70, 130, 255), -- Biru muda terang
	
		Dialog = Color3.fromRGB(15, 35, 70), -- Biru tua
		DialogHolder = Color3.fromRGB(25, 50, 100), -- Biru tua medium
		DialogHolderLine = Color3.fromRGB(70, 130, 255), -- Biru muda terang
		DialogButton = Color3.fromRGB(20, 40, 80), -- Biru tua gelap
		DialogButtonBorder = Color3.fromRGB(70, 130, 255), -- Biru muda terang
		DialogBorder = Color3.fromRGB(100, 150, 255), -- Biru muda
		DialogInput = Color3.fromRGB(30, 60, 110), -- Biru tua medium
		DialogInputLine = Color3.fromRGB(90, 160, 255), -- Biru muda lebih terang
	
		Text = Color3.fromRGB(255, 255, 255), -- Putih
		SubText = Color3.fromRGB(200, 220, 255), -- Biru sangat muda
		Hover = Color3.fromRGB(90, 160, 255), -- Biru muda terang
		HoverChange = 0.08,
	}    
}
...
local function CloseOpen()
	...
	Close_ImageButton.Image = "rbxassetid://72558237095001"
...
ElementsTable.TitleFitur = (function()
    local Element = {}
    Element.__index = Element
    Element.__type = "TitleFitur"

    function Element:New(Idx, Config)
        assert(Config.Title, "TitleFitur - Missing Title")
        ...
        -- Container utama
        TitleFitur.Container = New("Frame", {
            Size = UDim2.new(1, 0, 0, 0),
            BackgroundTransparency = 1,
            Parent = self.Container,
            LayoutOrder = 5, -- Order lebih tinggi agar di atas
        })

        -- Background dengan efek
        TitleFitur.Background = New("Frame", {
        ...
        -- Outer border
        TitleFitur.OuterBorder = New("UIStroke", {
            Thickness = 2,
            Transparency = 0.6,
            ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
            ThemeTag = {
        ...
        -- Inner border (dotted/dashed effect)
        TitleFitur.InnerBorder = New("UIStroke", {
            Thickness = 1,
            Transparency = 0.4,
            ApplyStrokeMode = Enum.ApplyStrokeMode.Contextual,
        ...
        -- Icon (jika ada)
        if TitleFitur.Icon then
            TitleFitur.IconLabel = New("ImageLabel", {
                Image = Library:GetIcon(TitleFitur.Icon),
                Size = UDim2.fromOffset(20, 20),
        ...
        -- Title text dengan font khusus
        local titlePosition = TitleFitur.Icon and UDim2.fromOffset(42, 10) or UDim2.fromOffset(14, 10)
        
        TitleFitur.TitleLabel = New("TextLabel", {
            RichText = true,
            Text = "<b>" .. TitleFitur.Title .. "</b>",
            FontFace = Font.new("rbxassetid://12187365364", Enum.FontWeight.SemiBold, Enum.FontStyle.Normal),
            TextSize = 16,
            TextColor3 = Color3.fromRGB(255, 255, 255),
            TextXAlignment = Enum.TextXAlignment.Left,
            TextYAlignment = Enum.TextYAlignment.Top,
            BackgroundTransparency = 1,
            Size = UDim2.new(1, TitleFitur.Icon and -50 or -28, 0, 20),
        ...
        -- Subtitle (jika ada)
        if TitleFitur.SubTitle ~= "" then
            TitleFitur.SubTitleLabel = New("TextLabel", {
                RichText = true,
                Text = TitleFitur.SubTitle,
                FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json"),
                TextSize = 12,
                ...
                TextYAlignment = Enum.TextYAlignment.Top,
                BackgroundTransparency = 1,
                Size = UDim2.new(1, TitleFitur.Icon and -50 or -28, 0, 14),
                Position = TitleFitur.Icon and UDim2.fromOffset(42, 26) or UDim2.fromOffset(14, 26),
                ThemeTag = {
                    TextColor3 = "SubText",
                },
            })
        ...
        TitleFitur.Separator = New("Frame", {
        ...
        -- Side brackets/decorators
        TitleFitur.LeftBracket = New("TextLabel", {
            Text = "⟦",
        ...
        TitleFitur.RightBracket = New("TextLabel", {
            Text = "⟧",
            FontFace = Font.new("rbxasset://fonts/families/Arial.json", Enum.FontWeight.Bold),
            TextSize = 20,
            TextColor3 = Color3.fromRGB(200, 200, 200),
        ...
        local children = {
            TitleFitur.Background,
            TitleFitur.OuterBorder,
            TitleFitur.InnerBorder,
            TitleFitur.TitleLabel,
            TitleFitur.Separator,
            TitleFitur.LeftBracket,
            TitleFitur.RightBracket,
        }

        if TitleFitur.IconLabel then
            table.insert(children, TitleFitur.IconLabel)
        end

        if TitleFitur.SubTitleLabel then
            table.insert(children, TitleFitur.SubTitleLabel)
        end

        for _, child in ipairs(children) do
            child.Parent = TitleFitur.Container
        end

        -- Update size berdasarkan subtitle
        local function updateSize()
            local height = TitleFitur.SubTitle ~= "" and 56 or 42
            TitleFitur.Container.Size = UDim2.new(1, 0, 0, height)
            TitleFitur.Background.Size = UDim2.new(1, -8, 0, height)
            TitleFitur.Separator.Position = UDim2.fromOffset(12, height - 1)
        end

        updateSize()

        -- Public methods
        function TitleFitur:SetTitle(NewTitle)
            TitleFitur.Title = NewTitle
            TitleFitur.TitleLabel.Text = "<b>" .. NewTitle .. "</b>"
        end

        function TitleFitur:SetSubTitle(NewSubTitle)
            TitleFitur.SubTitle = NewSubTitle or ""
            
            if TitleFitur.SubTitleLabel then
                if NewSubTitle and NewSubTitle ~= "" then
                    TitleFitur.SubTitleLabel.Text = NewSubTitle
                    TitleFitur.SubTitleLabel.Visible = true
                else
                    TitleFitur.SubTitleLabel.Visible = false
                end
            elseif NewSubTitle and NewSubTitle ~= "" then
                -- Create subtitle label jika belum ada
                TitleFitur.SubTitleLabel = New("TextLabel", {
                    RichText = true,
                    Text = NewSubTitle,
                    FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json"),
                ...
                TitleFitur.SubTitleLabel.Parent = TitleFitur.Container
            end
            
            updateSize()
        end

        function TitleFitur:SetIcon(IconName)
            local iconImage = Library:GetIcon(IconName)
            if iconImage then
                if TitleFitur.IconLabel then
                    TitleFitur.IconLabel.Image = iconImage
                else
                    TitleFitur.IconLabel = New("ImageLabel", {
                        Image = iconImage,
                        Size = UDim2.fromOffset(20, 20),
                    ...
                    TitleFitur.IconLabel.Parent = TitleFitur.Container
                    
                    -- Update title position
                    TitleFitur.TitleLabel.Position = UDim2.fromOffset(42, 10)
                    TitleFitur.TitleLabel.Size = UDim2.new(1, -50, 0, 20)
                    
                    if TitleFitur.SubTitleLabel then
                        TitleFitur.SubTitleLabel.Position = UDim2.fromOffset(42, 26)
                        TitleFitur.SubTitleLabel.Size = UDim2.new(1, -50, 0, 14)
                    end
                end
            elseif TitleFitur.IconLabel then
                TitleFitur.IconLabel:Destroy()
                TitleFitur.IconLabel = nil
                
                -- Reset positions
                TitleFitur.TitleLabel.Position = UDim2.fromOffset(14, 10)
                TitleFitur.TitleLabel.Size = UDim2.new(1, -28, 0, 20)
                
                if TitleFitur.SubTitleLabel then
                    TitleFitur.SubTitleLabel.Position = UDim2.fromOffset(14, 26)
                    TitleFitur.SubTitleLabel.Size = UDim2.new(1, -28, 0, 14)
                end
            end
        end

        function TitleFitur:SetVisible(Visible)
            TitleFitur.Container.Visible = Visible
        end

        function TitleFitur:Destroy()
            TitleFitur.Container:Destroy()
            Library.Options[Idx] = nil
        end

        TitleFitur.Visible = TitleFitur.SetVisible
        TitleFitur.Elements = TitleFitur

        -- Add to Library options jika perlu idx
        if Idx then
            Library.Options[Idx] = TitleFitur
        end
