...
ElementsTable.Slider = (function()
    ...
    function Element:New(Idx, Config)
        ...
        -- Rail utama - LEBIH BESAR untuk touch (30px height)
        ...
        -- Background rail (lebih besar untuk touch)
        ...
        -- Simple update function untuk PC dan HP
        local function updateSlider(scale, isTouch)
            ...
            -- Update visual
            Slider.Dot.Position = UDim2.new(0, dotPosition - (isTouch and 12 or 12), 0.5, 0)
        ...
        -- Universal dragging function (bekerja untuk MOUSE dan TOUCH)
        local function startDragging(input)
            ...
            -- RenderStepped connection untuk smooth update
            local connection
            connection = RunService.RenderStepped:Connect(function()
                if Slider.Dragging then
                    ...
                    if Slider.TouchInput then
                        -- TOUCH: Gunakan posisi touch terbaru
                        inputPosition = Slider.TouchInput.Position
                    else
                        -- MOUSE: Gunakan posisi mouse
        ...
        -- Stop dragging (universal)
        local function stopDragging()
            Slider.Dragging = false
            Slider.TouchInput = nil
        end

        -- INPUT BEGAN untuk MOUSE dan TOUCH
