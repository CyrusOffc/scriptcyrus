...
createMainUI = function(config)
    ...
    local CloseBtn, _     = MakeWinBtn(-10, "x", Color3.fromRGB(200,50,50))
    ...
    -- FIX 1: Active = true agar tidak block input
    ...
    SidebarScroll.Active = true  -- FIX: was false
    ...
    local function CreateTabButton(tabName, iconId, isConfig)
        ...
        -- FIX 2: Bungkus TabItem dalam Frame biasa, bukan Frame yang ada di scroll langsung
        ...
        -- FIX 3: ZIndex TabItem harus lebih tinggi dari SidebarScroll
        TabItem.ZIndex = 5
        ...
        -- FIX 4: TabBtn ZIndex jauh lebih tinggi, pastikan dia di atas semua child
        ...
        -- FIX 5: Gunakan MouseButton1Click sebagai fallback selain Activated
        TabBtn.Activated:Connect(function()
            CircleClick(TabBtn, Mouse.X, Mouse.Y)
            SwitchTab()
        end)

        -- FIX 6: Tambah MouseButton1Click untuk jaga-jaga Activated tidak fire
    ...
    -- FIX 7: CreateTab return hanya TabContent (Frame) sebagai container
    -- SwitchTab disimpan agar bisa dipanggil manual
    function Window:CreateTab(name, icon)
        ...
        -- FIX 8: kembalikan hanya cont sebagai container yang valid
        return cont
    end

    function Window:SwitchTab(name)
        -- FIX 9: method untuk switch tab dari luar
        for _, item in SidebarScroll:GetChildren() do
