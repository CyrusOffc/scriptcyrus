...
Components.Section = (function()
    ...
    return function(Title, Parent)
        ...
        -- Layout untuk elements
        Section.Layout = New("UIListLayout", {
            Padding = UDim.new(0, 5),
            SortOrder = Enum.SortOrder.LayoutOrder,
        })

        -- Container untuk elements (PENTING: parent ke Root nanti)
        Section.Container = New("Frame", {
            Size = UDim2.new(1, -10, 0, 0),  -- Height = 0 saat awal
            Position = UDim2.fromOffset(5, 28),  -- Turun di bawah title
            BackgroundTransparency = 1,
        ...
        Section.Root = New("Frame", {
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, 28),  -- Height awal hanya untuk title
            LayoutOrder = 7,
            Parent = Parent,  -- Parent ke tab container
        }, {
            -- Title dengan toggle button built-in
            New("TextButton", {
                Text = "  " .. Title,
            ...
            -- Toggle indicator di dalam text button untuk klik
            New("TextButton", {
                Text = "▼",
        ...
        -- Setelah Root dibuat, parent Container ke Root
        Section.Container.Parent = Section.Root
        ...
        local function updateSize()
            if Section.IsOpen then
                ...
                if contentHeight > 0 then
                    Section.Container.Size = UDim2.new(1, -10, 0, contentHeight)
                    Section.Root.Size = UDim2.new(1, 0, 0, contentHeight + 28)
                    Section.Container.Visible = true
                end
            else
                Section.Container.Size = UDim2.new(1, -10, 0, 0)
                Section.Root.Size = UDim2.new(1, 0, 0, 28)
        ...
        function Section:Toggle()
            ...
            local toggleIcon = Section.Root:FindFirstChild("ToggleIcon")
            if toggleIcon then
                toggleIcon.Text = Section.IsOpen and "▼" or "▶"
            end
        ...
        -- Event untuk klik title
        local titleButton = Section.Root:FindFirstChild("TextButton")
        if titleButton then
        ...
        -- Event untuk klik toggle icon - FIXED: Now using TextButton instead of TextLabel
        local toggleIcon = Section.Root:FindFirstChild("ToggleIcon")
        if toggleIcon then
            Creator.AddSignal(toggleIcon.MouseButton1Click, function()
                Section:Toggle()
            end)
        end
