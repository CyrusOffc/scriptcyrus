...
local Themes = {
	...
	CrimsonInferno = {
		Name = "CrimsonInferno",
		Accent = Color3.fromRGB(255, 60, 60), -- Merah terang menyala
		
		AcrylicMain = Color3.fromRGB(25, 10, 15), -- Hitam kemerahan gelap
		AcrylicBorder = Color3.fromRGB(80, 20, 25), -- Merah tua
		AcrylicGradient = ColorSequence.new(
			Color3.fromRGB(40, 10, 15), 
			Color3.fromRGB(20, 5, 8)
		), -- Gradient merah tua ke hitam
		AcrylicNoise = 0.6,
		
		TitleBarLine = Color3.fromRGB(255, 80, 80), -- Merah terang
		Tab = Color3.fromRGB(255, 70, 70), -- Merah cerah
		
		Element = Color3.fromRGB(220, 50, 50), -- Merah solid
		ElementBorder = Color3.fromRGB(120, 30, 30), -- Merah tua
		InElementBorder = Color3.fromRGB(255, 90, 90), -- Merah muda
		ElementTransparency = 0.7,
		
		ToggleSlider = Color3.fromRGB(180, 40, 40), -- Merah medium
		ToggleToggled = Color3.fromRGB(255, 255, 255), -- Putih
		
		SliderRail = Color3.fromRGB(200, 50, 50), -- Merah terang
		
		DropdownFrame = Color3.fromRGB(35, 10, 12), -- Merah gelap
		DropdownHolder = Color3.fromRGB(50, 15, 18), -- Merah medium gelap
		DropdownBorder = Color3.fromRGB(220, 60, 60), -- Merah terang
		DropdownOption = Color3.fromRGB(240, 80, 80), -- Merah muda terang
		
		Keybind = Color3.fromRGB(190, 50, 50), -- Merah medium
		
		Input = Color3.fromRGB(255, 200, 200), -- Merah sangat muda
		InputFocused = Color3.fromRGB(255, 255, 255), -- Putih
		InputIndicator = Color3.fromRGB(255, 70, 70), -- Merah terang
		
		Dialog = Color3.fromRGB(30, 10, 12), -- Merah gelap
		DialogHolder = Color3.fromRGB(45, 15, 18), -- Merah medium gelap
		DialogHolderLine = Color3.fromRGB(220, 60, 60), -- Merah terang
		DialogButton = Color3.fromRGB(25, 8, 10), -- Merah sangat gelap
		DialogButtonBorder = Color3.fromRGB(200, 50, 50), -- Merah medium
		DialogBorder = Color3.fromRGB(230, 70, 70), -- Merah terang
		DialogInput = Color3.fromRGB(40, 15, 18), -- Merah gelap
		DialogInputLine = Color3.fromRGB(240, 80, 80), -- Merah muda
		
		Text = Color3.fromRGB(255, 255, 255), -- Putih
		SubText = Color3.fromRGB(255, 180, 180), -- Merah muda
		Hover = Color3.fromRGB(240, 70, 70), -- Merah terang
		HoverChange = 0.1,
	}
}

CrimsonInferno2 = {
	Name = "CrimsonInferno2",
	Accent = Color3.fromRGB(255, 70, 70), -- Crimson terang (lebih classy)

	AcrylicMain = Color3.fromRGB(22, 8, 12),
	AcrylicBorder = Color3.fromRGB(90, 25, 30),
	AcrylicGradient = ColorSequence.new(
		Color3.fromRGB(45, 15, 20),
		Color3.fromRGB(18, 6, 9)
	),
	AcrylicNoise = 0.55,

	TitleBarLine = Color3.fromRGB(255, 90, 90),
	Tab = Color3.fromRGB(230, 65, 65),

	Element = Color3.fromRGB(200, 45, 45),
	ElementBorder = Color3.fromRGB(120, 25, 25),
	InElementBorder = Color3.fromRGB(255, 120, 120),
	ElementTransparency = 0.65,

	-- 🔥 TOGGLE FIX
	ToggleSlider = Color3.fromRGB(70, 20, 25), -- OFF rail (gelap)
	ToggleToggled = Color3.fromRGB(255, 110, 110), -- ON rail (crimson glow)
	ToggleKnob = Color3.fromRGB(255, 240, 240), -- knob putih soft

	SliderRail = Color3.fromRGB(90, 25, 30),

	DropdownFrame = Color3.fromRGB(30, 10, 14),
	DropdownHolder = Color3.fromRGB(55, 18, 22),
	DropdownBorder = Color3.fromRGB(220, 70, 70),
	DropdownOption = Color3.fromRGB(255, 110, 110),

	Keybind = Color3.fromRGB(210, 60, 60),

	Input = Color3.fromRGB(255, 210, 210),
	InputFocused = Color3.fromRGB(255, 255, 255),
	InputIndicator = Color3.fromRGB(255, 90, 90),

	Dialog = Color3.fromRGB(28, 9, 12),
	DialogHolder = Color3.fromRGB(48, 16, 20),
	DialogHolderLine = Color3.fromRGB(255, 90, 90),
	DialogButton = Color3.fromRGB(22, 7, 9),
	DialogButtonBorder = Color3.fromRGB(200, 55, 55),
	DialogBorder = Color3.fromRGB(255, 90, 90),
	DialogInput = Color3.fromRGB(42, 14, 18),
	DialogInputLine = Color3.fromRGB(255, 120, 120),

	Text = Color3.fromRGB(255, 255, 255),
	SubText = Color3.fromRGB(255, 190, 190),
...
ElementsTable.Slider = (function()
    ...
    function Element:New(Idx, Config)
        ...
        -- UI
        local SliderFrame = Components.Element(
            Config.Title,
            Config.Description,
            self.Container,
            false,
        ...
        local function updateVisual(scale)
            scale = math.clamp(scale, 0, 1)
            Slider.Fill:TweenSize(
                UDim2.fromScale(scale, 1),
            ...
            Slider.Dot:TweenPosition(
                UDim2.new(scale, 0, 0.5, 0),
                Enum.EasingDirection.Out,
                Enum.EasingStyle.Quad,
                0.12,
                true
        ...
        local function setFromScale(scale)
            local raw = Slider.Min + (Slider.Max - Slider.Min) * scale
            local newValue = snap(raw)

            if newValue == Slider.Value then
                updateVisual(valueToScale(newValue))
                return
            end
            ...
            local text = Config.FormatValue
                and Config.FormatValue(newValue)
                or tostring(newValue)

            Slider.ValueDisplay.Text = text
        ...
        local function beginDrag(input)
            ...
            local railPos = Slider.RailBackground.AbsolutePosition
            local railSize = Slider.RailBackground.AbsoluteSize
            ...
            moveConn = UserInputService.InputChanged:Connect(function(i)
                ...
                or i.UserInputType == Enum.UserInputType.Touch then
                    local x = (i.Position.X - railPos.X) / railSize.X
                    setFromScale(x)
                end
            end)
        end
        ...
        Creator.AddSignal(Slider.RailBackground.InputBegan, function(i)
            if i.UserInputType == Enum.UserInputType.MouseButton1
            or i.UserInputType == Enum.UserInputType.Touch then
                beginDrag(i)
                local x = (i.Position.X - Slider.RailBackground.AbsolutePosition.X)
                    / Slider.RailBackground.AbsoluteSize.X
                setFromScale(x)
            end
        end)

        Creator.AddSignal(UserInputService.InputEnded, function(i)
            if i.UserInputType == Enum.UserInputType.MouseButton1
            or i.UserInputType == Enum.UserInputType.Touch then
                endDrag()
            end
        ...
        function Slider:SetValue(value)
            local v = snap(value)
            Slider.Value = v
            updateVisual(valueToScale(v))
            Slider.ValueDisplay.Text = tostring(v)
        end
        ...
        function Slider:SetDisabled(state)
            ...
            Slider.RailBackground.BackgroundTransparency = state and 0.85 or 0.6
        end
...
function Library:ToggleTransparency(Value)
	if Library.Window then
		Library.Window.AcrylicPaint.Frame.Background.BackgroundTransparency = Value and 0.35 or 0.30
	end
end
